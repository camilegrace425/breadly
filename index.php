        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-8 lg:p-16 bg-breadly-bg relative z-10">
            <div class="w-full max-w-md space-y-6">
                ...
                <div class="space-y-4">
                    ...
                    <form action="nav/pos.php" method="get" class="animate-slide-in delay-200">
                    ...
                    <?php if ($role == 'cashier'): ?>
                        <form action="nav/sales_history.php" method="get" class="animate-slide-in delay-300">
                    ...
                    <?php if ($role == 'manager' || $role == 'assistant_manager'): ?>
                        <form action="nav/dashboard_panel.php" method="get" class="animate-slide-in delay-300">
                    ...
                    <?php if ($role == 'manager'): ?>
                        <form action="nav/account_management.php" method="get" class="animate-slide-in delay-400">
                    ...
                    <div class="pt-6 border-t border-orange-200 animate-slide-in delay-500">
